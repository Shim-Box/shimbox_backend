...
public class ResponseWeeklyWorkStatsDto {
    ...
    @Schema(description = "조회 기간 시작일", example = "2025-01-13T00:00:00")
    private LocalDateTime startDate;

    @Schema(description = "조회 기간 종료일", example = "2025-01-19T23:59:59")
    private LocalDateTime endDate;

    @Schema(description = "일별 근무 통계 목록")
    private List<DailyWorkStats> dailyStats;

    @Schema(description = "총 근무 시간 (분)", example = "2400")
    private Long totalWorkMinutes;

    @Schema(description = "총 배달 건수", example = "45")
    private Integer totalDeliveryCount;

    @Schema(description = "평균 일일 근무 시간 (분)", example = "342")
    private Double averageDailyWorkMinutes;

    @Schema(description = "평균 일일 배달 건수", example = "6.4")
    ...
    public static class DailyWorkStats {
        ...
        @Schema(description = "배달 건수", example = "8")
        private Integer deliveryCount;

        @Schema(description = "출근 시간", example = "2025-01-13T09:00:00")
        private LocalDateTime workStartTime;

        @Schema(description = "퇴근 시간", example = "2025-01-13T17:00:00")
        private LocalDateTime workEndTime;
    }

    public static ResponseWeeklyWorkStatsDto from(Driver driver, LocalDateTime startDate, LocalDateTime endDate,
